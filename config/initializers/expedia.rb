Expedia.setup do |config|
  ...
  config.api_key = '5fd6485clmp3oogs8gfb43p2uf'
  config.shared_secret = 'cjkao1pfqt0tk'
  ...
  config.timeout = 30 # read timeout in sec
  config.open_timeout = 30 # connection timeout in sec
end
